...
public class PrivateBank implements Bank {
     ...
     * @param outgoing
     */
    public PrivateBank(String name, double incoming, double outgoing)
    {
        set_name(name);
     ...
     * @param tempBank
     */
    public PrivateBank(PrivateBank tempBank)
    {
    ...
    public boolean equals(Object tempObj) {
        PrivateBank obj = (PrivateBank) tempObj;
    ...
    public double getAccountBalance(String account) {
        ...
        for (Transaction t : temp) {
            balance += t.calculate(); // calculate() returns - or + amount depending on in- or outgoing transfer
        }
        return balance;
    }
